...
jpeg(paste0("Fig#_weight_effect_plots_per_eel", today, ".jpg"), height = 8.5, width = 7, units = "in", res = 600)
...
write.csv(weight_summary_df, file = "weight_per_eel_percent_decline.csv", row.names = FALSE)
...
py3 <- ggplot(weight_percent_df, aes(x = pd)) +
  ...
  xlab("Percentage decline in individual eel weight trend 1987-2025") +
...
jpeg(paste0("Fig#_weight_per_eel_trend_plots", today, ".jpg"), height = 2.3, width = 10, units = "in", res = 600)
grid.arrange(py2, nrow =1)
dev.off()

#then plot py3 for the supplemental appendix
jpeg(paste0("Fig#_weight_per_eel_percent_decline_plots", today, ".jpg"), height = 2.3, width = 10, units = "in", res = 600)
